      ...
      <Container maxWidth="xl" className="py-8 mt-4 sm:mt-8 flex-grow">
        ...
        <Box className="mb-10 p-6 sm:p-12 rounded-[3rem] border border-slate-200/60 bg-white/80 shadow-2xl shadow-slate-200/20 dark:border-slate-700/60 dark:bg-slate-900/50 dark:shadow-none">
          <Box className="flex items-center gap-4 mb-6">
            <Box className="h-12 w-12 rounded-2xl bg-violet-100 dark:bg-violet-900/40 text-violet-600 dark:text-violet-400 flex items-center justify-center shadow-inner">
              <PeopleRounded />
            </Box>
            <div>
              <Typography variant="h4" className="!font-black dark:!text-white">Studentët</Typography>
              <Typography variant="body1" className="text-slate-500 dark:text-slate-400">Menaxhoni studentët e regjistruar.</Typography>
            </div>
          </Box>
          <Typography variant="body2" className="text-slate-400 dark:text-slate-600 italic">
            Lista e studentëve do të shfaqet këtu së shpejti.
          </Typography>
        </Box>
