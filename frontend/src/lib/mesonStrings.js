...
export const STRINGS = {
  sq: {
    ...
    auth: {
      ...
      registerSubtitle:
        "Bashkohu në Meson për të nisur mësimin—falas për të filluar.",
      firstName: "Emri",
      lastName: "Mbiemri",
      ...
      chooseRoleHint:
        "Zgjidh rolin që të përshtatet—kjo përcakton se çfarë mjetesh shikon.",
      ...
      termsHint:
        'Hap dokumentet më sipër dhe konfirmo me "Lexova dhe kuptova" për të aktivizuar kutinë.',
      ...
      errTermsMsg1:
        'Hapni Kushtet e Shërbimit, Politikën e Privatësisë dhe Rregullat e Cookies dhe shtypni "Lexova dhe kuptova" për secilën.',
      errTermsMsg2:
  ...
  en: {
    ...
    auth: {
      ...
      termsHint:
        'Open each document above and confirm with "I have read and understood" to enable the checkbox.',
      ...
      errTermsMsg1:
        'Open the Terms of Service, Privacy Policy, and Cookie Policy and tap "I have read and understood" for each.',
      errTermsMsg2:
    ...
    about: {
      ...
      ctaFinalBody:
        "Create an account and explore courses and the Meson experience.",
